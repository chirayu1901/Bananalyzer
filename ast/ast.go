...
type Program struct {
	Statements []Statement // This is our source code
}

// Implementing this function means that Program now implements Node interface
...
type LetStatement struct {
	Token token.Token // the token.LET tokeb
	Name  *Identifier
	Value Expression
}
